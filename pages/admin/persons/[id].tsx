              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{person.address.address}, <span className="mt-1 text-sm text-gray-500">{person.address.island.atoll}. {person.address.island.name}</span></dd>
                  </div>
                  <div className="sm:col-span-1">
