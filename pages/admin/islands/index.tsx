...
export default function IslandList() {
  ...
  useEffect(() => {
    ...
    api.get(`/islands?page=${page}&${params}`).then((resp: any) => {
      setLoading(false);
          ...
          <div className="flex rounded-md shadow-sm space-x-2">
            <div className="relative flex-grow focus-within:z-10">
              ...
              <Input
                ...
                onChange={e => !e.target.value && router.push('/admin/islands')}
              />
            </div>
              <button
...
IslandList.getLayout = function getLayout(page: ReactElement) {
  return (
    <Layout>
